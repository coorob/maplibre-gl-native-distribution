...
| Tag | Base | Fix | Slices |
|-----|------|-----|--------|
| `6.27.0-traska.79-rc1` | MapLibre Native [`ios-v6.27.0`](https://github.com/maplibre/maplibre-native/releases/tag/ios-v6.27.0) + Traska terrain work [`3805a080`](https://github.com/coorob/maplibre-native/commit/3805a0800d58575100ab23249e3af73c40c75920) | Release candidate: invalidates terrain-draped hillshade drawables when a source tile's parent/child mask changes, preventing stale masked geometry from stacking translucent shade during camera cover transitions | `ios-arm64` (device) + `ios-arm64_x86_64-simulator` |
...
`6.27.0-traska.79-rc1`. The repo is public, so SwiftPM downloads the framework anonymously — no auth.
...
```ruby
$MLRN_NATIVE_VERSION = "6.27.0-traska.79-rc1"
$MLRN_SPM_SPEC = {
  url: "https://github.com/coorob/maplibre-gl-native-distribution",
  requirement: { kind: "exactVersion", version: "6.27.0-traska.79-rc1" },
...
gh release create 6.27.0-traska.79-rc1 "$ZIP" --repo coorob/maplibre-gl-native-distribution --prerelease
# then bump url + checksum in Package.swift, commit, `git tag 6.27.0-traska.79-rc1`, push --tags
```
